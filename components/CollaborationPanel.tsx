    ...
    return (
      <div className="flex items-center gap-3 bg-amber-900/20 border border-amber-600/30 px-3 py-1.5 rounded-lg animate-in fade-in zoom-in-95">
        <div className="flex flex-col">
          <span className="text-[9px] uppercase font-bold text-amber-500 tracking-widest leading-none">Command ID</span>
        ...
        <div className="flex items-center gap-2">
           ...
           <span className="text-[10px] uppercase font-bold text-slate-300">{connectedCount} Linked</span>
        </div>
        <button 
  ...
  if (role === 'CLIENT') {
    return (
      <div className="flex items-center gap-3 bg-blue-900/20 border border-blue-600/30 px-3 py-1.5 rounded-lg animate-in fade-in zoom-in-95">
        <div className="flex flex-col">
          <span className="text-[9px] uppercase font-bold text-blue-400 tracking-widest leading-none">Viewer Mode</span>
          <span className="text-xs font-bold text-white tracking-widest">OBSERVER</span>
        </div>
